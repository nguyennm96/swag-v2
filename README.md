...
Or download a pre-compiled binary from the [release page](https://github.com/nguyennm96/swag-v2/releases).
...
Find the example source code [here](https://github.com/nguyennm96/swag-v2/tree/master/example/celler).
...
Find the result of formatting [here](https://github.com/nguyennm96/swag-v2/tree/master/example/celler).
...
**Example**
[celler/main.go](https://github.com/nguyennm96/swag-v2/blob/master/example/celler/main.go)
...
[#708](https://github.com/nguyennm96/swag-v2/issues/708) The parser handles only struct comments starting with `@Description` attribute.
...
[#379](https://github.com/nguyennm96/swag-v2/issues/379)
```go
...
[#980](https://github.com/nguyennm96/swag-v2/issues/980)
[#1177](https://github.com/nguyennm96/swag-v2/issues/1177)
